use super::super::definitions::Image;
use super::super::point::Point;
use super::line::{draw_antialiased_line_segment_mut, draw_line_segment_mut};
use super::Canvas;
    ...
    C: Canvas,
{
    ...
    draw_line_segment_mut(canvas, (first.x, first.y), (last.x, last.y), color);
}
